...
// Generated by AI - created as part of comparePlanets, did not have to change
function safeNumber(value: string) {
  const number = parseInt((value ?? "").toString().replace(/,/g, ""), 10);
  return Number.isFinite(number) ? number : Number.NaN;
}

// Generated by AI - do the sorting for the planets, did not have to change
...
// Generated by AI - part of reduceResidentsData, did not have to change
 ...
 * ```
 */
// Generated by AI - worked fine but had to refine for a better BigO, I added test to make sure it was working
